...
///В [MultiProvider] создаются объекты классов, реализующие шаблон проектирования [Provider].
///Цель в том, что мы создаем один единственный экземпляр каждого из классов.
///Свойства каждого из экземпляров становятся доступны всем дочерним виджетам,
///т.о. всему приложению.
